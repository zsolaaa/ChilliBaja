...
<!-- ══════════════════ KAPCSOLAT ══════════════════ -->
<section id="kapcsolat" class="py-20 px-6 max-w-7xl mx-auto">
  <div class="text-center mb-12">
    <p class="text-xs font-semibold uppercase tracking-widest text-[#5b4039] mb-2">Írj nekünk</p>
    <h2 class="font-serif text-3xl md:text-4xl font-bold text-[#f5ede8]">Kapcsolat</h2>
  </div>
  <?php echo do_shortcode( '[contact-form-7 id="contact-form" title="Kapcsolat"]' ); ?>
</section>
